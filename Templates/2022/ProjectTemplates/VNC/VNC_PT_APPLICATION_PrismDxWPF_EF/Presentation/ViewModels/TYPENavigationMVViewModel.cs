...
{
    public class $xxxTYPExxx$NavigationMVViewModel : EventViewModelBase, I$xxxTYPExxx$NavigationMVViewModel, IInstanceCountVM
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$NavigationMVViewModel(
        ...
        public async Task LoadAsync()
        {
            ...
            foreach (var item in lookup$xxxTYPExxx$s)
            {
                $xxxTYPExxx$s.Add(
                     ...
                     nameof($xxxTYPExxx$DetailMVViewModel),
        ...
        public virtual void AddNavigationItem(
        ...
        public virtual void DeleteNavigationItem(
            ObservableCollection<NavigationItemViewModel> items,
