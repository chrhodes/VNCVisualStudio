...
{
    public partial class $xxxTYPExxx$DetailMVD : ViewBase, IStepD, I$xxxTYPExxx$DetailMV, IInstanceCountV
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$DetailMVD()
        {
            Int64 startTicks = 0;
        ...
        public $xxxTYPExxx$DetailMVD(I$xxxTYPExxx$DetailMVViewModel viewModel)
        {
