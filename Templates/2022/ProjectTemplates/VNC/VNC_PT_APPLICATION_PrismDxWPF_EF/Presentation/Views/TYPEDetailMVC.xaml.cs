...
{
    public partial class $xxxTYPExxx$DetailMVC : ViewBase, IStepC, I$xxxTYPExxx$DetailMV, IInstanceCountV
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$DetailMVC()
        {
            Int64 startTicks = 0;
        ...
        public $xxxTYPExxx$DetailMVC(I$xxxTYPExxx$DetailMVViewModel viewModel)
        {
