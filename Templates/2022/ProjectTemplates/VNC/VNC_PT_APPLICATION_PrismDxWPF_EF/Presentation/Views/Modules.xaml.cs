...
{
    public partial class Modules : ViewBase, IModules, IInstanceCountV
    {
        ...
        public Modules()
        {
            ...
            // ViewModel = (IModuleCatalogViewModel)DataContext;

            // Can create directly

            // ViewModel = ModuleCatalogViewModel();

            // ViewModel = new ModuleCatalogViewModel(
        ...
        public Modules(IModulesViewModel viewModel)
        {
