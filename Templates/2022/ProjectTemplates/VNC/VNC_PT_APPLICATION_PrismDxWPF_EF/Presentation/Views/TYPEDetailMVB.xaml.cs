...
{
    public partial class $xxxTYPExxx$DetailMVB : ViewBase, IStepB, I$xxxTYPExxx$DetailMV, IInstanceCountV
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$DetailMVB()
        {
            Int64 startTicks = 0;
        ...
        public $xxxTYPExxx$DetailMVB(I$xxxTYPExxx$DetailMVViewModel viewModel)
        {
