...
{
    public partial class $xxxTYPExxx$NavigationMV : ViewBase, I$xxxTYPExxx$NavigationMV, IInstanceCountV
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$NavigationMV()
        {
            Int64 startTicks = 0;
            ...
            // ViewModel = new $xxxTYPExxx$NavigationMVViewModel(
        ...
        public $xxxTYPExxx$NavigationMV(I$xxxTYPExxx$NavigationMVViewModel viewModel)
        {
            Int64 startTicks = 0;
