...
{
    public partial class $xxxTYPExxx$DetailMVA : ViewBase, IStepA, I$xxxTYPExxx$DetailMV, IInstanceCountV
    {
        #region Constructors, Initialization, and Load

        public $xxxTYPExxx$DetailMVA()
        {
            Int64 startTicks = 0;
        ...
        public $xxxTYPExxx$DetailMVA(I$xxxTYPExxx$DetailMVViewModel viewModel)
        {
